...
#     parser.add_argument('--video_splits', type=str, default='./splits/PSI200_split.json',
    ...
    parser.add_argument('--video_splits', type=str, default='/home/dydy/proj_idc8208/dataset/PSI2.0_TrainVal/splits/PSI2_split.json',
                        help='video splits, [PSI100_split | PSI200_split | PSI200_split_paper]')
    parser.add_argument('--dataset_root_path', type=str, default='/home/dydy/proj_idc8208/dataset',
                        help='Path of the dataset, e.g. frames/video_0001/000.jpg')
    parser.add_argument('--database_path', type=str, default='/home/dydy/proj_idc8208/dataset/',
...
#                              'consensus > 0.5 are selected and reweigh loss; -1.0 means not use; 0.0, means all are used.')
    ...
    parser.add_argument('--input_size', type=int, default=4, help="Dimension of input features")
    # parser.add_argument('--hidden_dim', type=int, default=64, help="Dimension of hidden LSTM layer")
    parser.add_argument('--output_dim', type=int, default=1, help="Output dimension for intent prediction")
    # parser.add_argument('--num_layers', type=int, default=1, help="Number of layers in LSTM")
    parser.add_argument('--fine_tune', type=bool, default=False, help="Enable fine-tuning mode")
    ...
    parser.add_argument('--input_dim', type=int, default=4)  # Number of features for bboxes
    parser.add_argument('--hidden_dim', type=int, default=64)  # Hidden size for transformer
    parser.add_argument('--num_layers', type=int, default=2)  # Number of transformer encoder layers
