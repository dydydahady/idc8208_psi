...
#     parser.add_argument('--video_splits', type=str, default='./splits/PSI200_split.json',
    ...
    parser.add_argument('--input_size', type=int, default=32, help='Input feature size')
    parser.add_argument('--hidden_dim', type=int, default=128, help='LSTM hidden dimension size')
