...
#                              'consensus > 0.5 are selected and reweigh loss; -1.0 means not use; 0.0, means all are used.')
    ...
    # parser.add_argument('--class_weights', type=list, default=[1.0, 1.0])  # Weight for class imbalance
    
    parser.add_argument('--device', type=str, default='cuda:0')
    parser.add_argument('--observe_length', type=int, default=15)  # Added observe_length parameter
