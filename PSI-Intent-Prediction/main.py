...
def main(args):
    ...
    # ''' 4. Test '''
    # test_gt_file = '../dataset/test_intent_gt.json'
...
if __name__ == '__main__':
    ...
    if args.dataset == 'PSI2.0':
        # args.video_splits = os.path.join(args.dataset_root_path, 'dataset/PSI2.0_TrainVal/splits/PSI2_split.json')
    ...
    # Model
    args.model_name = 'transformer_int_bbox'  # LSTM module, with bboxes sequence as input, to predict intent
